...
private val cancelFineTuneResponse = CancelFineTuneResponse(
...
/**
 * Test fixture for [CancelFineTuneResponse].
 */
class CancelFineTuneResponseTest : DataClassSerializationCommonTest<CancelFineTuneResponse>(
    serializer(),

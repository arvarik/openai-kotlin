...
class CreateEmbeddingsResponseTest : DataClassSerializationCommonTest<CreateEmbeddingsResponse>(
    ...
    expectedSerializedString =
        """{"object":"Test object","data":[{"object":"Test embedding 1","embedding":[0.0,1.0,2.0],"index":0},
        |{"object":"Test embedding 2","embedding":[3.0,4.0,5.0],"index":0}],"model":"text-ada-001",
        |"usage":{"prompt_tokens":100,"total_tokens":201}}
        """.trimMargin(),
    invalidSerializedString =
        """{"object":"Test object","data":[{"object":"Test embedding 1","embedding":[0.0,1.0,2.0],"index":0},
        |{"object":"Test embedding 2","embedding":[3.0,4.0,5.0],"index":0}],"model":"text-ada-001",
        |"usage":{"promptTokens":100,"totalTokens":201}}
        """.trimMargin(),
)

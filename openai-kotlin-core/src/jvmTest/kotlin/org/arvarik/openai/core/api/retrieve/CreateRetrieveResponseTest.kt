...
class CreateRetrieveResponseTest : DataClassSerializationCommonTest<RetrieveModelResponse>(
    ...
    expectedSerializedString =
        """{"id":"Test id","object":"Test model","created":1671910080,
        |"owned_by":"String","permission":[{"id":"Test id","object":"Test model","created":1671910080,
        |"allow_create_engine":false,"allow_sampling":true,"allow_logprobs":true,"allow_search_indices":false,
        |"allow_view":true,"allow_fine_tuning":false,"organization":"*","is_blocking":false}],"root":"Test root"}
        """.trimMargin(),
    invalidSerializedString =
        """{"id":"Test id","object":"Test model","created":1671910080,
        |"ownedBy":"String","permission":[{"id":"Test id","object":"Test model","created":1671910080,
        |"allowCreateEngine":false,"allowSampling":true,"allowLogprobs":true,"allowSearchIndices":false,
        |"allowView":true,"allowFineTuning":false,"organization":"*","isBlocking":false}],"root":"Test root"}
        """.trimMargin(),
)

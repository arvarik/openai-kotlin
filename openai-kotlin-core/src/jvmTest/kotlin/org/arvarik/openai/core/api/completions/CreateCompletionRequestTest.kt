...
class CreateCompletionRequestTest : DataClassSerializationCommonTest<CreateCompletionRequest>(
    ...
    expectedSerializedString =
        ...
        |"suffix":"suffix","max_tokens":20,"temperature":0.5,"top_p":0.1,"presence_penalty":1.0,
        |"best_of":15,"logit_bias":{"1":25,"2":26}}
        """.trimMargin(),
    invalidSerializedString =
        """{"model":"text-davinci-003","prompt":"Test prompt",
        |"suffix":"suffix","maxTokens":20,"temperature":0.5,"top_p":0.1,"presencePenalty":1.0,
        |"bestOf":15,"logitBias":{"1":25,"2":26}}
        """.trimMargin(),
)

...
class CreateEditRequestTest : DataClassSerializationCommonTest<CreateEditRequest>(
    serializer(),
    createEditRequest,
    expectedSerializedString = """{"model":"text-davinci-003","input":"Test input","instruction":"Test instruction","n":2,"temperature":0.6,"top_p":0.4}""",
    invalidSerializedString = """{"model":"text-davinci-003","input":"Test input","instruction":"Test instruction","n":2,"temperature":0.6,"topP":0.4}"""
)
